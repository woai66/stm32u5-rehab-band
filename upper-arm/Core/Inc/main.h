...
#define DATA_TXD_Pin GPIO_PIN_2
#define DATA_TXD_GPIO_Port GPIOA
#define DATA_RXD_Pin GPIO_PIN_3
#define DATA_RXD_GPIO_Port GPIOA
...
#define LCD_SDO_Pin GPIO_PIN_11
